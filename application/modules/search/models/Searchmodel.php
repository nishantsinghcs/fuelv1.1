...
class Searchmodel extends CI_Model{	
	...
	public function term_meaning($term,$lang) {
		$this->db->select('*');
		$this->db->from('string_suggestions');
		$this->db->where('string_id',$term);
	...
	public function get_code_from_lang($language_id) {
