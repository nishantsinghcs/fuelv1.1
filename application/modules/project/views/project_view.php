...
<div class="container">
  <h2>Projects</h2>
  <p>Contribute and minimise the workload for your Project</p>
    ...
    foreach ($project as $key => $value) { 
    	...
    	<div class="card <?php if($value->status=='1'){ ?>bg-success<?php }else { ?>bg-warning <?php }?>">
	      <div class="card-body text-center">
	        ...
	        <p><small>
            <?php //var_dump(); ?>
            <?=$count[$key][0]; ?> Strings remaining</small></p>
	      </div>
	    </div>
	<?php }  ?>
  </div>
...
<div class="container">
  <h2>Languages</h2>
  <p>Select to see workload for your language</p>
   <p class="bg-light">
      <?php foreach ($languages as $value) { ?>
        <a href="<?php echo base_url();?>/project/lang/<?=$value->language_code ?>" style="text-transform:uppercase"><?=$value->language_name ?></a> | 
      <?php  } ?>
    </p>
</div>
